function Zweipunkt(block, varargin)
...
if nargin == 1      % that's the usual way
    ...
    case 'output'   % Outputs
        ...
        [y,X{id}]=mZweipunkt('output',t,X{id},u',p);
...
p = block.DialogPrm(1).Data;
[nu,ny,acc,Ts,~]=mZweipunkt('init',0,[],[],p);   
%                                 ^-- woher t ???
